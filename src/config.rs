...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> =  { let mut map = HashMap::new(); map.insert("password".to_string(), "Kr10291029*".to_string()); RwLock::new(map)};    
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["littlechihuo.uicp.vip"];
pub const RS_PUB_KEY: &str = "KUfJqe3CyGer7CfiHDF8qdbV5Lx4p8EuANxm0dlCS8c=";
